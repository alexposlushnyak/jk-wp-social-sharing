...
class social_digg extends jk_wp_social_sharing
{

    public function get_digg_share_link($post_title, $post_url, $post_thumb, $post_excerpt)
    {
    ...
    public function the_digg_share_link_render($post_id, $type = 'default')
    {
        ...
        if ($type === 'default'):
            ...
            <a href="<?php echo esc_url($this->get_digg_share_link($title, $url, $thumbnail, $excerpt)); ?>"
